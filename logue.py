...
class dialogue:
    ...
    #----------
    list_8 = ["This is the entrance to the factory. Back then..... No one in the village went near here. In fact no one talked about its origin or its name. Only the Village cheif knew it. He said saying its name out loud would attract more of  'THEM'. Not that it matters anymore. Be carefull going inside. "]
    #----------
    ...
    #----------
    list_14 = ["WOW! I never this factory would be hiding something like this!"]
    #----------
    ...
    #----------
    list_16 = ["this is the dialogue for list 16"]
